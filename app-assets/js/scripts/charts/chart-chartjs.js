...
$(window).on("load", function () {
  ...
  var linechartOptions = {
    ...
    title: {
      display: true,
      text: 'Total User Visits by Restaurant Classification'
    }
  };

  // Chart Data
  var linechartData = {
    labels: [2004, 2005, 2006, 2007, 2009, 2012, 2014, 2016, 2018, 2019],
    datasets: [{
      label: "Restobar",
  ...
  var horizontalchartOptions = {
    ...
    title: {
      display: true,
      text: 'Predicted Customer by Restaurant Classification'
    }
  };

  // Chart Data
  var horizontalchartData = {
    labels: ["Restobar", "Korean Restaurant", "Filipino Restaurant", "Pizza Parlour", "Coffee Shop"],
    datasets: [{
      label: "Customers",
      data: [2478, 5267, 734, 784, 433],
      backgroundColor: themeColors,
